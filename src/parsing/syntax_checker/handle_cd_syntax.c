...
/*   Updated: 2024/11/11 14:27:54 by rpires-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (current_index == 0 || isspace(command[current_index - 1]))
	{
		if (strncmp(command + current_index, "cd", 2) == 0
			&& (command[current_index + 2] == '\0'
				|| isspace(command[current_index + 2])))
		{
